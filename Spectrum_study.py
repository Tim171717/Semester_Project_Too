...
c = Connection('tfessler@rainbow', connect_kwargs={"password": "PASSWORD"})
...
for m in ms:
    filename = f"spectrumVH2O_M={m:.2g}"
    filenames.append(filename)
    yaml_dict = {
    		"RUN SETTINGS": {
        		"wavelength_range": [3.5, 19.5],
        		"output_folder": "/home/tfessler/results/spectrum_run_M/" + filename + ".txt",
        		"include_scattering": {
            		"Rayleigh": False,
            		"thermal": False,
            		"direct_light": False,
    ...
    with open('config_files/' + filename + ".yaml", "w") as f:
